...
#     parser.add_argument('--config', type=str, default='./scripts/ease_food.json',
#                         help='Json file of settings.')
#     return parser

def setup_parser():
    parser = argparse.ArgumentParser(description='Reproduce of multiple pre-trained incremental learning algorithms.')
    parser.add_argument('--config', type=str,default='./scripts/cllora_cub_B0_Inc20_debug.json', help='Json file of settings.')
    return parser
