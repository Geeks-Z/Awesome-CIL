...
class iCore50(iData):
    ...
    def download_data(self):
        ...
        datagen = CORE50(root='/home/team/zhaohongwei/Dataset/core50_128x128', scenario="ni")
...
class iCIFAR100_vit(iData):
    ...
    def download_data(self):
        label_mapping = {i: i // 20 for i in range(100)}
        train_dataset = datasets.cifar.CIFAR100('/home/team/zhaohongwei/Dataset', train=True, download=True)
        test_dataset = datasets.cifar.CIFAR100('/home/team/zhaohongwei/Dataset', train=False, download=True)
        self.train_data, self.train_targets = train_dataset.data, np.array(train_dataset.targets)
        self.test_data, self.test_targets = test_dataset.data, np.array(test_dataset.targets)
        # self.train_data, self.train_targets = train_dataset.data, np.array([label_mapping.get(t, t) for t in train_dataset.targets])
        # self.test_data, self.test_targets = test_dataset.data, np.array([label_mapping.get(t, t) for t in test_dataset.targets])
...
class i5Datasets_vit(iData):
    ...
    def download_data(self):
        ...
        # cifar10
        cifar10_train_dataset = datasets.cifar.CIFAR10('/home/team/zhaohongwei/Dataset', train=True, download=True)
        cifar10_test_dataset = datasets.cifar.CIFAR10('/home/team/zhaohongwei/Dataset', train=False, download=True)
        ...
        # MNIST
        minist_train_dataset = datasets.MNIST('/home/team/zhaohongwei/Dataset', train=True, download=True)
        minist_test_dataset = datasets.MNIST('/home/team/zhaohongwei/Dataset', train=False, download=True)
        ...
        tarin_dir = "/home/team/zhaohongwei/Dataset/notMNIST_large"
        test_dir = "/home/team/zhaohongwei/Dataset/notMNIST_small"
        ...
        # Fashion-MNIST
        fminist_train_dataset = datasets.FashionMNIST('/home/team/zhaohongwei/Dataset', train=True, download=True)
        fminist_test_dataset = datasets.FashionMNIST('/home/team/zhaohongwei/Dataset', train=False, download=True)
        ...
        # SVHN
        svhn_train_dataset = datasets.SVHN('/home/team/zhaohongwei/Dataset', split='train', download=True)
        svhn_test_dataset = datasets.SVHN('/home/team/zhaohongwei/Dataset', split='test', download=True)
